                    ...
                    <div id="transContent" style="min-width: 600px">
                        ...
                        <main>
                            <form class="form-horizontal form-label-left" id="formEntry" method="post">    
                                ...
                                <input type="hidden" class="{{$data['classFormControl']}}" id="idTr" value="" name="idTrGr">    
                                <div class="row ">
                                ...
                                <div class="row form_custom"> 
                                    ...
                                    <div class="col-sm-6">                                                                                
                                        ...
                                        @else
                                            ...
                                            <input type="hidden" class="{{$data['classFormControl']}}" id="kode_perkiraan1" value="" name="kode_perkiraan1" >
                                            <input type="hidden" class="{{$data['classFormControl']}}" id="nama_perkiraan1" value="" name="nama_perkiraan1" >
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-md-6">
                                                <label for="inputCity" class="form-label" style="color:blue; font-size:10pt; font-weight:bold">D / K</label>
                                                <select class="{{$data['classFormSelect']}}" name="id_transaksi" id="id_transaksi" onchange="getval3(this);">                                                    
                                                    <option value="1">Debit (Pencairan)</option>
                                                    <option value="2">Kredit (Penempatan)</option>                                                   
                                                </select>                                                
                                        ...
                                        <div class="row">                                                                                         
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                @else
                                                    ...
                                                    <input type="hidden" class="{{$data['classFormControl']}}" id="nama_perkiraan2" value="" name="nama_perkiraan2" >
                                                    <input type="hidden" class="{{$data['classFormControl']}}" id="kode_perkiraan2" value="" name="kode_perkiraan2" >
                                                @endif
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form_custom1" id="show_table2"></div>
                                        <hr>
...
<script src="{{ asset('additional/js/transaksi_deposito.js') }}"></script>
