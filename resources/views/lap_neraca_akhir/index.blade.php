        ...
        <div id="myModalHorizontalprint" style="margin:10px">
            ...
            <div class="row">
                <div class="col-sm-6 overflow-auto">
                    <div class="form_custom1" id="show_table_left" style="font-size:12px"></div>
				</div>	
                <div class="col-sm-6 overflow-auto">
                    <div class="form_custom1" id="show_table_right" style="font-size:12px"></div>
                </div>        
            </div>
       </div>
    </div>
...
<script src="{{ asset('additional/js/lap_neraca_akhir.js') }}"></script>
