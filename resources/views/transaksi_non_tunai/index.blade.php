                            ...
                            <form class="form-horizontal form-label-left" id="formEntry" method="post">    
                                ...
                                <div class="row form_custom"> 
                                    ...
                                    <div class="col-sm-6">                                                                                                                        
										...
										<input type="text" class="{{$data['classFormControl']}}" id="keterangan2" value="" onkeydown="upperCaseF(this)" disabled name="keterangan2">
                                    </div>        
                                    <div class="col-sm-6">
...
<script src="{{ asset('additional/js/transaksi_non_tunai.js') }}"></script>
