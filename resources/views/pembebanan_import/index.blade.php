<?php
//if(!isset($LNilaiTukar[0]->name) || $LNilaiTukar[0]->name=="" ) $LNilaiTukar[0]->name = "";
//if(!isset($LNilaiTukar[0]->kurs_jual)) $LNilaiTukar[0]->kurs_jual = "";
//if(!isset($LNilaiTukar[0]->kurs_beli)) $LNilaiTukar[0]->kurs_beli = "";
?>
                                ...
                                <div class="border p-3 rounded">
                                    ...
                                    <div class="row form_custom"> 
                                        <div class="col-sm-6">                                                                                                                                                                    
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-4">
                                                    <label for="inputCity" class="form-label" style="color:blue; font-weight:bold">Nilai L/C (USD)</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label for="inputCity" class="form-label" style="color:blue; font-weight:bold">Set. Jaminan (%)</label>
                                                    <input type="text" class="{{$data['classFormControl']}}" id="setoran_jaminan" value="" name="setoran_jaminan" >                                                    
                                                    <label for="setoran_jaminan" generated="true" class="error"></label>
                                                    <label id="validationError"></label>
                                                </div>                                  
                                                <div class="col-md-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>                                                                                
                                                            ...
                                                            <h4 class="my-1 text-white">{{number_format($LNilaiTukar[0]->kurs_beli ) ?? ""}}</h4>
                                                            <p class="mb-0 font-13 text-white">Kelas : {{isset($LNilaiTukar[0]->name) ? $LNilaiTukar[0]->name : ""}}</p>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            ...
                                                            <p class="mb-0 font-13 text-white">Kelas : {{$LNilaiTukar[0]->name ?? "0"}}</p>
            ...
            <div class="row">
				<div class="d-flex align-items-center"> 
					...
					<div class="col-sm-11" style="margin-left:30px">
						...
						<h6 class="name font-16"><a href="javascript:;">Pembebanan Import</a></h6>                  
					</div>
				</div> 
            </div>
            <br><br>
            ...
            <div class="table-responsive">
                <table id="tableContent" class="table align-middle mb-0" style="margin-left:20px">
                    <thead>
                        <tr>
                            <th>I.</th>
                            <th>NILAI SET.JAM L/C YANG DIBUKA</th>
                            <th></th>
                            <th>USD</th>
                        ...
                        <tr>
                            <th>III.</th>
                            <th>NILAI SET.JAM L/C YANG DIBUKUKAN</th>
                            <th>D</th>
                            <th></th>
                        ...
                        <tr>
                            <th>IV.</th>
                            <th>KOMISI L/C IMPORT <span id="data_IV_0"></span></th>
                            <th>K</th>
                            <th>USD</th>
                        ...
                        <tr>
                            <th>VII.</th>
                            <th>JUMLAH YANG DIBAYAR IMPORTIR</th>
                            <th>K</th>
                            <th></th>
...
<script src="{{ asset('additional/js/pembebanan_import.js') }}"></script>
