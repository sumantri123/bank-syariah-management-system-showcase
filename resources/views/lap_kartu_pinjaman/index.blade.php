...
<div class="card border-top border-0 border-4 border-success" id="contentJB">
    <div class="card-body" >
        ...
        <div id="myModalHorizontalprint" style="margin:10px">
            ...
            <div class="row">
                <div class="col-sm-2">
					<label class="form-label">Nama Nasabah</label><br>
					<label class="form-label">No. Rekening</label><br>
                    <label class="form-label">Jenis Pembiayaan</label><br>
                    
                    
                </div>
                <div class="col-sm-3">
                    <label class="form-label"><span id="namaNasabah"></span></label><br>
                    <label class="form-label"><span id="noRekening"></span></label><br>
                    <label class="form-label"><span id="jenisPinjaman"></span></label><br>
                </div>

                <div class="col-sm-3">
                    <label class="form-label">Margin Ditangguhkan</label><br>
					<label class="form-label">Nominal Pembiayaan</label><br>
					<label class="form-label">Jangka Waktu</label><br>                    
                </div>
                <div class="col-sm-4">
                    <label class="form-label"><span id="bungaNominal"></span></label><br>                    
					<label class="form-label"><span id="nominalPinjaman"></span></label><br>
					<label class="form-label"><span id="jangkaWaktu"></span></label><br>
                </div>               
            </div>
            <hr/>
