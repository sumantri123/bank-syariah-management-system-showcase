...
class LapNasabahGiroController extends Controller
{
    /**
    ...
    {		
        $data = array(
            'title' => 'POSISI SALDO NASABAH GIRO RUPIAH',
        ...
        //return view('lap_nasabah_giro/index', compact('data'));        
        $returnHTML = view('lap_nasabah_giro/index',compact('data'))->render();
    ...
    public function getData(Request $request)
    {
        ...
        //             "jurnal_det_nominal"=> $cekData[$a]->sa_giro_temp,
        ...
        $dataTable = DB::select(
            DB::raw('
                SELECT nama, nomor_rekening, df_trans_perkiraan, a.id, prk,
