...
class LapMutasiHarianController extends Controller
{
    /**
    ...
    {		                    
        ...
        //return view('lap_mutasi_harian/index', compact('data'));        
        $returnHTML = view('lap_mutasi_harian/index',compact('data'))->render();
    ...
    public function getData(Request $request)
    {
        ...
        if(count($getJumlahTgl)>0){
            ...
            $cariData = DB::select(                
                ...
                DB::raw("
                        ...
                        left join (
                            ...
                            and id_perkiraan = ".Session::get('1XXKATEL_ID')."
                            group by id_perkiraan
                            order by id_perkiraan
                        ) as d on a.id = d.id_perkiraan
                        where id = ".Session::get('1XXKATEL_ID')."
            ...
            $LEditPerkiraan = EditPerkiraan::where('kode_perkiraan','like','%'.Session::get('1XXKATEL').'%')
